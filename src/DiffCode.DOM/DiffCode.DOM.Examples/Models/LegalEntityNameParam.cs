...
/// <summary>
/// Параметр, типизированный названием организационно-правовой формы стороны.
/// </summary>
public class LegalEntityNameParam : BaseParamWithFactory<LegalEntityName, LegalEntityName.Factory>
{
  public LegalEntityNameParam([CallerMemberName] string memberName = "") : base(memberName)
  {
